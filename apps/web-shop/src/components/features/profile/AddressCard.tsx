  ...
  return (
    ...
    >
      <div className="flex gap-4">
        <span className="text-[var(--primary)] text-xl mt-0.5">📍</span>
        <div>
      ...
      <div className="flex gap-2">
        <button
          ...
          className="p-2 rounded-lg text-gray-500 hover:text-[var(--primary)] hover:bg-gray-100 transition-colors cursor-pointer text-sm"
          title="Edit address"
        >
          ✏️ Edit
        </button>
        <button
          ...
          className="p-2 rounded-lg text-[var(--error)] hover:bg-[var(--error-container)]/30 transition-colors cursor-pointer text-sm"
